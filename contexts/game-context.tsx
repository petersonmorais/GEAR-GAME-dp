...
const ALL_CARDS: Card[] = [
  ...
  {
    id: "nightmare-armageddon",
    name: "Ultimate Guardian de Lil-Laep: Nightmare Armageddon",
    image: "/cards/nightmare-armageddon.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Darkus",
    dp: 0,
    ability: "NIGHTMARE ARMAGEDDON",
    abilityDescription: "Quando está equipado em Lil-Laep, ele concede os seguintes efeitos: -Lil-Laep ganha +7 DP. -Você pode selecionar 1 Card de unidade com 3 ou menos de DP no campo do seu oponente e destrua-o. Esta habilidade só pode ser ativada somente uma única vez.",
    attack: "",
  ...
  {
    id: "kensei-ifraid",
    name: "Ultimate Guardian de Jaden: Kensei Ifraid",
    image: "/cards/kensei-ifraid.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Pyrus",
    dp: 0,
    ability: "KENSEI IFRAID",
    abilityDescription: "Quando equipada em Jaden, IFRAID concede os seguintes efeitos: Jaden ganha +3 DP. Você pode selecionar e destruir 1 Card no campo do seu oponente. Se o Card destruído por este efeito for uma unidade, cause 4 DP de dano direto aos LP do oponente.",
    attack: "",
  ...
  {
    id: "isgrimm-fenrir",
    name: "Ultimate Guardian de Ventus: Ísgrimm Fenrir",
    image: "/cards/isgrimm-fenrir.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Ventus",
    dp: 0,
    ability: "ÍSGRIMM FENRIR",
    abilityDescription: "Quando está equipado em Unidade Ventus, ele concede os seguintes efeitos: -Unidade Ventus ganha +2DP. -Quando a Unidade Ventus ataca: Você pode selecionar uma Carta de Unidade Ventus do seu campo e ela ganha +2DP, esse efeito não pode ser aplicado na Unidade que esse Guardião está equipado.",
    attack: "",
    category: "Ventus Ultimate Guardian",
    requiresUnit: "Unidade Ventus",
  },
  {
    id: "mefisto-foles",
    name: "Ultimate Guardian de Arthur: Mefisto Fóles",
    image: "/cards/mefisto-foles.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Darkus",
    dp: 0,
    ability: "MEFISTO FÓLES",
    abilityDescription: "Quando está equipado em Arthur, ele concede os seguintes efeitos: Arthur ganha +2 DP. Você pode selecionar 1 Card no campo do seu oponente e destrua-o. Esta habilidade de controle pode ser ativada somente uma única vez por duelo.",
    attack: "",
    category: "Darkness Ultimate Guardian",
    requiresUnit: "Arthur",
  },
